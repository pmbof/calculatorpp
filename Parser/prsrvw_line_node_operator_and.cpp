...
void CParserView::line::node_operator_and::set(sset* ss)
{
...
void CParserView::line::node_operator_and::draw(sdraw* sd) const
{
	sd->begin_expr(this);
	if (_left)
	{
...
inline CParserView::line::bnodetypes CParserView::line::node_operator_and::type() const
{
	return bndOprAnd;
}
