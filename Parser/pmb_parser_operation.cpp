...
const operation<_TVALUE> operation_table<_TVALUE>::_opr[] = {
	...
	operation<_TVALUE>("!", 250, true, "factorial", "factorial", operations<_TVALUE>::factorial),
	...
	operation<_TVALUE>("", 110, true, "product implicit", "multiplication implicit or call function", operations<_TVALUE>::multiplication, true),
	operation<_TVALUE>(" ", 110, true, "product space", "multiplication space or call function", operations<_TVALUE>::multiplication, true),
	operation<_TVALUE>(" ", 110, false, "product space inverse", "multiplication space or call function right to left", operations<_TVALUE>::multiplication, true),
